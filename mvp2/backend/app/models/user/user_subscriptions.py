...
from sqlalchemy import Enum as SqlEnum, BigInteger, DateTime, ForeignKey, String
...
class UserSubscription(Base):
  ...
  subscription_id: Mapped[int] = mapped_column("SUBSCRIPTION_ID", BigInteger, primary_key=True)
